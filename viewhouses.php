...
<table align="center">
  <h1 align="center"><u>House Details</u></h1>
  <tr>
...
$sql="SELECT house_no,house_name,vacancy FROM houses_tb";
$run = mysqli_query($conn,$sql);
if($run-> num_rows > 0)
{
  while ($row = $run-> fetch_assoc()){
    echo "<tr><td>".$row["house_no"]."</td><td>".$row["house_name"]."</td><td>".$row["vacancy"]."</td></tr>";
      }
      echo "</table>";
    }
    else
...
<a href="upordel_house.php"><input type="submit" name="update" class="btn btn-info" value="Update/Delete"></a>

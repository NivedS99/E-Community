...
<table align="center">
  <h1 align="center"><u>Emergency Contact Details</u></h1>
  <tr>
    <th>Name</th>
    <th>Contact No</th>
    <th>Occupation</th>
...
$sql="SELECT name,phone,occupation FROM emergency_tb";
$run = mysqli_query($conn,$sql);
if($run-> num_rows > 0)
{
  while ($row = $run-> fetch_assoc()){
    echo "<tr><td>".$row["name"]."</td><td>".$row["phone"]."</td><td>".$row["occupation"]."</td></tr>";
      }
      echo "</table>";
    }
    else
...
<a href="upordel_em.php"><input type="submit" name="update" class="btn btn-info" value="Update/Delete"></a>
